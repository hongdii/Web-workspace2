...
%>
<!-- request.getContextPath()는 contextroot 즉, /jspproject/ -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	<script>
					// ssesion 객체 반환형은 object여서 String으로 형변환해줌
		const msg = "<%= alertMsg %>";
		if(msg != "null"){ // "성공적으로 로그인이 되었습니다" / null
			alert(msg);
			// 알람창을 띄워준 후 session에 담긴 메세지는 지워줘야함
			// 안그러면 menubar.jsp가 로딩될때마다 매번 alert 함수가 실행됨
