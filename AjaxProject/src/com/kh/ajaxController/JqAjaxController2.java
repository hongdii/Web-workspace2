...
//		response.getWriter().print(responseData);
		...
		// 버전 2) 응답데이터 여러개 보내고싶을때 "JSON"형태로 데이터 셋팅
		/*
		 ...
		 *   
		 *   1. JSONArray[value, value, value] : 배열형태(문자열로 이루어짐)
		 *   2. JSONObject[key:value, key:value] : 객체형태(문자열로 이루어짐)
		 */
		
		// JSONArray로 배열 전달 해주기
//		JSONArray jArr = new JSONArray(); // []
//		jArr.add(name); //["홍길동"]
//		jArr.add(age); //["40"]
//		
//		// 응답할 데이터의 contentType을  설정. text/html -> 문자열
//		// apllication/json -> json 타입. (이 형태 외우기)
...
//		response.getWriter().print(jArr);
		...
		jobj.put("name", name);	// {name:"현지"}
		jobj.put("age", age);	// {name:"현지", age:"20"}
