 ...
 * Generated at: 2023-03-07 04:44:42 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/menubar.jsp", Long.valueOf(1678163566416L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("     회원탈퇴	     | 					|				  |		O		|       O \r\n");
      out.write("   \r\n");
      out.write("   * 공지사항서비스  - 공지사항리스트조회(R) / 공지사항상세조회(R) / 공지사항 작성(C) / 수정(U) / 삭제(U/D)\r\n");
      out.write("   \r\n");
      out.write("   * 일반게시판서비스 - 공지사항리스트조회(R) / 공지사항상세조회(R) / 공지사항 작성(C) - (첨부파일 1개 업로드) / 수정(U) / 삭제(U/D)\r\n");
      out.write("                    [댓글리스트 조회(R)/작성(C)]\r\n");
      out.write("   * 사진게시판서비스 -  리스트조회(R) / 상세조회(R) / 작성(C) - (다중첨부파일 업로드)\r\n");
      out.write("   \r\n");
      out.write(" -->\r\n");
      out.write(" \r\n");
      out.write(" ");
 ...
 if(loginUser == null) {
      ...
      out.write("				\r\n");
      out.write("				// 제이쿼리 방식 .is()\r\n");
      out.write("				if($(\"#saveId\").is(\":checked\")){ // true 체크된 상태\r\n");
      out.write("					// 세미콜론으로 쿠키 속성값 분류\r\n");
      out.write("					document.cookie = \"saveId=\"+userId+\"; path=/; max-age=\"+60*60*24; // 쿠키최대 유지시간 설정(1일)\r\n");
      ...
      out.write("				let value = \"\";\r\n");
      out.write("				\r\n");
      out.write("				//document.cookie 값 문자열\r\n");
      out.write("				if(document.cookie.length > 0){\r\n");
      out.write("					// indexOf() 로 여러 쿠키들중 해당하는 것의 시작위치가져옴\r\n");
      out.write("					let index = document.cookie.indexOf(\"saveId=\");\r\n");
      out.write("					\r\n");
      out.write("					if(index != -1){ // saveId라는 키값의 쿠키가 있다면\r\n");
      out.write("						\r\n");
      out.write("						// saveId= 이라는 값이 input에 나오지않도록\r\n");
      out.write("						// 그길이를 index에 대입\r\n");
      out.write("						index += \"saveId=\".length;\r\n");
      out.write("						\r\n");
      out.write("						// ; 를 인덱스 끝나는 위치로 두고, \r\n");
      out.write("						// 불필요한 문자열(saveId=)의 길이를 두번째\r\n");
      out.write("						// 매개변수로 둬서 saceId= 뒤의 인덱스부터 ; 까지\r\n");
