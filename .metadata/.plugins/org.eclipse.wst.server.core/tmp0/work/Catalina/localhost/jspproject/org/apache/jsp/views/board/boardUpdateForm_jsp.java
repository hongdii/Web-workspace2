 ...
 * Generated at: 2023-02-22 01:40:44 UTC
...
public final class boardUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) {
      ...
      out.write("		<br>\r\n");
      out.write("		<h2 align=\"center\">일반게시판 수정하기</h2>\r\n");
      out.write("		<br>\r\n");
      out.write("		<!-- enctype : 서버로 제출될 때 해당 데이터가 인코딩되는 방법을 명시 \r\n");
      out.write("			enctype=\"multipart/form-data\" : 파일(<input type=\"file\">)이 포함된 폼을 전송할 때 사용\r\n");
      out.write("		-->\r\n");
      out.write("		<form action=\"");
      out.print( contextPath);
      out.write("/update.bo\" id=\"update-form\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("			<input type=\"hidden\" name=\"bno\" value=\"");
      out.print( b.getBoardNo() );
      out.write("\">\r\n");
      out.write("			<!-- 카테고리, 제목, 내용, 첨부파일을 입력받고, 작성자 정보 -->\r\n");
 ...
 for(Category c : list) { 
      ...
      out.write("\r\n");
      out.write("							<!-- 내가 선택한 카테고리가 자동으로 선택되어있도록 작업해주기(js활용) -->\r\n");
      out.write("						</select>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
 ...
 if(at != null) { 
      ...
      out.write("\r\n");
      out.write("							<!-- 원본파일의 파일번호, 수정명을 hidden 함께 전송할 예정 -->\r\n");
      out.write("							<input type=\"hidden\" name=\"originFileNo\" value=\"");
      out.print( at.getFileNo() );
      out.write("\">\r\n");
      out.write("							<input type=\"hidden\" name=\"changeFileName\" value=\"");
