 ...
 * Generated at: 2023-03-07 01:37:35 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/menubar.jsp", Long.valueOf(1676255222000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<!-- 컨트롤러에서 넘겨받은 board객체 b를 변수 b에 저장 -->\r\n");
 Board b = (Board) request.getAttribute("b"); 
   Attachment at = (Attachment) request.getAttribute("at");
   ArrayList<Reply> list = (ArrayList<Reply>) request.getAttribute("list");

      out.write("\r\n");
      out.write("<!-- 글번호 카테고리 제목 작성자 조회수 작성일 -->\r\n");
 ...
 if(loginUser == null) {
      ...
      out.write("				<td colspan=\"3\">\r\n");
      out.write("<!-- 					첨부파일이 없을경우 : 첨부파일이 없습니다로 표시 -->\r\n");
      out.write("<!-- 					첨부파일이 있을경우 :  -->\r\n");
      out.write("<!-- 					<a download=\"파일원본명\" href=\"해당파일이존재하는경로\">파일원본명</a> -->\r\n");
      out.write("					");
 if(at == null) { 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("					<!-- href='/jspproject/resources/board_upfiles/2022xxxxxxx.jpg' -->\r\n");
      ...
      out.write("		\r\n");
      out.write("			<!-- 로그인한 사용자가 해당 게시글의 작성자인 경우 -->\r\n");
      out.write("			");
 if(loginUser != null && loginUser.getUserId().equals(b.getBoardWriter())) { 
      out.write("\r\n");
      out.write("				<a href=\"");
      out.print( contextPath );
      out.write("/update.bo?bno=");
      out.print( b.getBoardNo() );
      out.write("\" class=\"btn btn-warning btn-sm\">수정하기</a>\r\n");
      out.write("				<button onclick=\"deleteBoard();\" class=\"btn btn-danger btn-sm\">삭제하기</button>\r\n");
      out.write("				\r\n");
      out.write("			");
 } 
      out.write("\r\n");
      ...
      out.write("// 				confirm함수 이용해서 alert창 이용\r\n");
      out.write("// 				alert창에서 취소버튼을 누르면 창을 빠져나갈수있게 논리부정연산자를 confirm함수 앞에\r\n");
      out.write("// 				붙여줌				\r\n");
      ...
      out.write("		\r\n");
      out.write("		<br>\r\n");
      out.write("		<!-- 댓글기능 화면구현만 해두기 . 요 아래는 작업x -->\r\n");
 ...
 if(loginUser != null){ 
      ...
      out.write("							<th>댓글작성</th>\r\n");
      out.write("							<td>\r\n");
      out.write("								<textarea id=\"replyContent\" cols=\"50\" rows=\"3\" style=\"resize:none;\" readonly>로그인후 이용가능한 서비스입니다.</textarea>\r\n");
      out.write("							</td>\r\n");
 ...
 for(Reply r : list) {
      ...
      out.write("// 					 댓글 등록 성공시 result = 1\r\n");
      out.write("					if(result > 0){\r\n");
      out.write("						// 새 댓글 목록 불러오는 함수 호출\r\n");
      out.write("						selectReplyList();\r\n");
      out.write("						\r\n");
      out.write("						// 댓글내용 비워주기\r\n");
      out.write("						$(\"#replyContent\").val(\"\");\r\n");
      out.write("						\r\n");
      out.write("					}else{ // 댓글 등록 실패시 result = 0\r\n");
      out.write("						alert(\"댓글 작성에 실패했습니다.\");\r\n");
      out.write("					}\r\n");
      out.write("				},\r\n");
      out.write("				error: function(){\r\n");
      out.write("					console.log(\"댓글작성실패\");\r\n");
      out.write("				}\r\n");
      out.write("			\r\n");
      out.write("			})\r\n");
      out.write("			\r\n");
      ...
      out.print( b.getBoardNo() );
      out.write("\"},\r\n");
      out.write("				success : function(list){ // 배열형태 매개변수받음\r\n");
      out.write("					\r\n");
      out.write("					// 서버로부터 전달받은 리스트를 반복문을 통해 댓글목록으로 변환\r\n");
      out.write("					let result = \"\";\r\n");
      out.write("					\r\n");
      out.write("					// list가 배열이라 반복문 사용가능\r\n");
      out.write("					for(let i of list){\r\n");
      out.write("						result += \"<tr>\"\r\n");
      out.write("									+ \"<td>\"+ i.replyWriter +\"</td>\"\r\n");
      ...
      out.write("				},\r\n");
      out.write("				error: function(){\r\n");
      out.write("					console.log(\"게시글 목록조회 실패\");\r\n");
      out.write("				}\r\n");
      out.write("			});\r\n");
      out.write("		}\r\n");
      out.write("	</script>\r\n");
