 ...
 * Generated at: 2023-03-06 03:11:21 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1676255222000L));
  }
 ...
 if(loginUser == null) {
      ...
      out.write("	                <tr>\r\n");
      out.write("	                    <td>* 아이디</td>\r\n");
      out.write("	                    <td><input type=\"text\" id=\"userId\" name=\"userId\" maxlength=\"12\" required></td>\r\n");
      ...
      out.write("	            \r\n");
      out.write("	            <div align=\"center\">\r\n");
      out.write("	            	<button id=\"submit\" type=\"submit\" disabled>회원가입</button>\r\n");
      ...
      out.write("			// 아이디를 입력하는 input 요소 얻어오기.\r\n");
      out.write("			// #enroll-form [name=userId]\r\n");
      out.write("			// name이 userId인 요소가 menubar.jsp에서도 존재하므로, 확실하게 어디에 속해있는지 잘 적어줘야한다.\r\n");
      ...
      out.write("						// 사용가능한 경우\r\n");
      out.write("						// confirm() 의 반환값은 true/false\r\n");
      out.write("						if(confirm(\"사용 가능한 아이디입니다. 사용 하시겠습니까?\")){\r\n");
      out.write("							\r\n");
      out.write("							// 아이디값 수정할 수 없게 막기\r\n");
      out.write("							$(\"#userId\").attr(\"readonly\", true);\r\n");
      out.write("							\r\n");
      out.write("							// (그이전까지는 회원가입 불가능) 회원가입 버튼 활성화\r\n");
      out.write("							// #enroll-form :submit\r\n");
