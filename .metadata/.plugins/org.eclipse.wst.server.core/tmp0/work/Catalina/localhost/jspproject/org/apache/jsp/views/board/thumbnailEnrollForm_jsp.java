 ...
 * Generated at: 2023-02-22 06:00:13 UTC
...
public final class thumbnailEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) {
      ...
      out.write("				<!-- 대표이미지 required 속성 부여 \r\n");
      out.write("					 onchange 이벤트는 버튼을 누르거나 속성에 대한 입력이 끝났을때 발생함 -->\r\n");
      ...
      out.write("					// num : 몇번째 input요소인지 확인 후 해당영역에 미리보기하기위한 변수\r\n");
      out.write("					\r\n");
      out.write("					//console.log(inputFile.files[0]);\r\n");
      out.write("					/*\r\n");
      out.write("						파일 선택시 length = 1, 파일선택 취소시 length=0 배열안의 내용이 비어있게됨.\r\n");
      out.write("						length값을 가지고 파일의 존재유무를 알수가 있다.\r\n");
      out.write("						\r\n");
      out.write("						files속성은 업로드된 파일의 정보들을 \"배열\"형식으로 여러개 묶어서 반환, length 그 배열의 크기를 의미\r\n");
      out.write("					*/\r\n");
      out.write("					\r\n");
      out.write("					if(inputFile.files.length != 0){\r\n");
      out.write("						// 선택된 파일이 존재할 경우에 선택된 파일들을 읽어들여서 그 영역에 맞는곳에 미리보기 추가\r\n");
      out.write("						\r\n");
      out.write("						// 파일을 읽어들일 FileReader 객체 생성\r\n");
      out.write("						let reader = new FileReader();\r\n");
      out.write("						\r\n");
      out.write("						// 파일을 읽어들이는 메소드 -> 어느파일을 읽을지 매개변수에 제시해줘야함.\r\n");
      out.write("						// 0번째 인덱스에 담긴 파일정보를 제시\r\n");
      out.write("						// -> 해당파일을 읽어들이는 순간 해당파일만의 고유한 url부여됨.\r\n");
      out.write("						// -> 해당 url을 src속성값으로 제시\r\n");
      out.write("						reader.readAsDataURL(inputFile.files[0]);\r\n");
      out.write("						\r\n");
      out.write("						// 파일읽기가 완료되었을때 실행할 함수 정의\r\n");
      out.write("						reader.onload = function(e){ // e.target.result에 고유한 url부여됨.\r\n");
      out.write("													 // e.target : 로드 완료된 객체를 가리킴\r\n");
      out.write("							// 각 영역에 맞춰서 이미지 미리보기 기능 제시\r\n");
      ...
      out.write("						\r\n");
      out.write("					}else{\r\n");
      out.write("						// 선택된 파일이 없을경우 미리보기도 함께 사라지게끔 작업.\r\n");
      out.write("						switch(num){\r\n");
